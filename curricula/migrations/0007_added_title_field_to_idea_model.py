...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('curricula_idea', 'title', self.gf('django.db.models.fields.CharField')(max_length=256, null=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Idea.title'
        db.delete_column('curricula_idea', 'title')
