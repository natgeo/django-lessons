...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ObjectiveRelation'
        db.create_table('curricula_objectiverelation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('objective', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['curricula.LearningObjective'])),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('curricula', ['ObjectiveRelation'])

    def backwards(self, orm):
        # Deleting models
        db.delete_table('curricula_objectiverelation')
        db.delete_table('curricula_learningobjective')
