...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'IdeaCategory.subtitle_guiding_question'
        db.alter_column('curricula_ideacategory', 'subtitle_guiding_question', self.gf('django.db.models.fields.TextField')(null=True, blank=True))

    def backwards(self, orm):
        # Changing field 'IdeaCategory.subtitle_guiding_question'
        db.alter_column('curricula_ideacategory', 'subtitle_guiding_question', self.gf('django.db.models.fields.TextField')())
