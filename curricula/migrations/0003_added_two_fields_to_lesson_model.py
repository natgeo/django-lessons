...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lesson.prior_knowledge'
        db.add_column('curricula_lesson', 'prior_knowledge', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Lesson.prior_knowledge'
        db.delete_column('curricula_lesson', 'prior_knowledge')
