...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lesson.instructional_pathways'
        db.add_column('curricula_lesson', 'instructional_pathways', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lesson.instructional_pathways'
        db.delete_column('curricula_lesson', 'instructional_pathways')
    ...
    models = {
        ...
        'core_media.ngphoto': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '250', 'null': 'True', 'db_index': 'True'}),
