...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.alter_column('reference_vocabulary', 'glossary_term_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reference.GlossaryTerm']))

    def backwards(self, orm):
        db.alter_column('reference_vocabulary', 'glossary_term_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['edu_core.GlossaryTerm']))
    ...
    models = {
        'bundle.bundle': {
            ...
            'object_id_order': ('django.db.models.fields.TextField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
        ...
        'reference.genericarticle': {
            ...
            'reporting_categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['reporting.ReportingCategory']", 'null': 'True', 'blank': 'True'}),
            'resource_carousel': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bundle.Bundle']", 'null': 'True', 'blank': 'True'}),
            'secondary_content_types': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['edumetadata.AlternateType']", 'null': 'True', 'blank': 'True'}),
        ...
        'reference.glossaryterm': {
            ...
            'is_geography_glossary': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'reference.vocabulary': {
            'Meta': {'ordering': "['glossary_term']", 'object_name': 'Vocabulary'},
            'generic_article': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'misc'", 'to': "orm['reference.GenericArticle']"}),
