...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('curricula', ['Unit'])

        # Adding M2M table for field subjects on 'Unit'
        db.create_table('curricula_unit_subjects', (
        ...
        db.create_unique('curricula_unit_subjects', ['unit_id', 'subject_id'])

        # Adding M2M table for field grades on 'Unit'
        db.create_table('curricula_unit_grades', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('unit', models.ForeignKey(orm['curricula.unit'], null=False)),
            ('grade', models.ForeignKey(orm['edumetadata.grade'], null=False))
        ))
        db.create_unique('curricula_unit_grades', ['unit_id', 'grade_id'])

        # Adding M2M table for field eras on 'Unit'
        db.create_table('curricula_unit_eras', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('unit', models.ForeignKey(orm['curricula.unit'], null=False)),
            ('historicalera', models.ForeignKey(orm['edumetadata.historicalera'], null=False))
        ))
        db.create_unique('curricula_unit_eras', ['unit_id', 'historicalera_id'])

        # Adding model 'UnitRelation'
        db.create_table('curricula_unitrelation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['curricula.Unit'])),
        ...
        db.send_create_signal('curricula', ['UnitRelation'])

        # Adding model 'UnitLesson'
        db.create_table('curricula_unitlesson', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('curricula', ['UnitLesson'])
    ...
    models = {
        ...
        'curricula.lesson': {
            ...
            'prior_knowledge': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'prior_lessons': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'prior_lessons_rel_+'", 'null': 'True', 'to': "orm['curricula.Lesson']"}),
            'published': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'published_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
